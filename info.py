#!/usr/bin/env python
"""
This file contains parameters for ROYGBIV to fill settings in setup.py,
the ROYGBIV top-level docstring, and for building the docs.
In setup.py we execute this file, so it cannot import roygbiv.
"""
...
ROYGBIV is a web app to view the outputs of Mindboggle: the automated
feature extraction, anatomical
...
MAINTAINER_EMAIL    = "anishakeshavan AT gmail.com"
...
AUTHOR_EMAIL        = "anishakeshavan AT gmail.com"
